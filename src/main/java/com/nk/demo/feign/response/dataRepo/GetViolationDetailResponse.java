...
/**
 * @title GetViolationDetailResponse
 * @Description: todo
 * @Author tianwl
 * @Company 中科美络科技股份有限公司
 * @Email tianwl@izkml.com
 * @Date 2024/9/18 11:23
 */
@Data
public class GetViolationDetailResponse {

    private List<GetViolationDetailItem> detail;
    private String content;
    private String fileName;

    @Data
    public static class GetViolationDetailItem{
